...
public class RootlessSAIPackageInstaller extends SAIPackageInstaller {
    ...
    private RootlessSAIPackageInstaller(Context c) {
        ...
        ContextCompat.registerReceiver(getContext(), mFurtherInstallationEventsReceiver, new IntentFilter(RootlessSAIPIService.ACTION_INSTALLATION_STATUS_NOTIFICATION), ContextCompat.RECEIVER_NOT_EXPORTED);
        sInstance = this;
    }
