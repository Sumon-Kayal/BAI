...
import com.sumon.bundleapp.installer.installerx.postprocessing.DeviceInfoAwarePostprocessor;
import com.sumon.bundleapp.installer.installerx.postprocessing.HugeAppWarningPostprocessor;
import com.sumon.bundleapp.installer.installerx.postprocessing.SortPostprocessor;
import com.sumon.bundleapp.installer.installerx.resolver.appmeta.DefaultAppMetaExtractor;
import com.sumon.bundleapp.installer.installerx.resolver.meta.impl.DefaultSplitApkSourceMetaResolver;
import com.sumon.bundleapp.installer.installerx.resolver.urimess.SourceType;
import com.sumon.bundleapp.installer.installerx.resolver.urimess.UriHost;
import com.sumon.bundleapp.installer.installerx.resolver.urimess.UriMessResolutionError;
import com.sumon.bundleapp.installer.installerx.resolver.urimess.UriMessResolutionResult;
import com.sumon.bundleapp.installer.installerx.resolver.urimess.UriMessResolver;
import com.sumon.bundleapp.installer.installerx.resolver.urimess.impl.AndroidUriHost;
import com.sumon.bundleapp.installer.installerx.resolver.urimess.impl.DefaultUriMessResolver;
...
public class InstallerXDialogViewModel extends ViewModel {
    ...
    private void install(ApkSource apkSource, @Nullable String packageName) {
        mInstaller.enqueueSession(mInstaller.createSessionOnInstaller(mPrefsHelper.getInstaller(), new SaiPiSessionParams(apkSource, packageName)));
    }
