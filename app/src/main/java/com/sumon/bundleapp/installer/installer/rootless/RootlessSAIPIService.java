package com.sumon.bundleapp.installer.installer.rootless;
...
import com.sumon.bundleapp.installer.ui.activities.ConfirmationIntentWrapperActivity;
...
public class RootlessSAIPIService extends Service {
    ...
    public static final String ACTION_INSTALLATION_STATUS_NOTIFICATION = "com.sumon.bundleapp.installer.action.INSTALLATION_STATUS_NOTIFICATION";
    public static final String EXTRA_INSTALLATION_STATUS = "com.sumon.bundleapp.installer.extra.INSTALLATION_STATUS";
    public static final String EXTRA_SESSION_ID = "com.sumon.bundleapp.installer.extra.SESSION_ID";
    public static final String EXTRA_PACKAGE_NAME = "com.sumon.bundleapp.installer.extra.PACKAGE_NAME";
    public static final String EXTRA_ERROR_DESCRIPTION = "com.sumon.bundleapp.installer.extra.ERROR_DESCRIPTION";
