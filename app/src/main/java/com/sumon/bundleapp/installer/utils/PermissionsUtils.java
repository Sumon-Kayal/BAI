...
public class PermissionsUtils {
     ...
     * <p>
     * Kept deliberately separate from Environment.isExternalStorageManager() for API 30+, since
     * that check alone doesn't grant the permission — it requires a Settings redirect flow
     * (ACTION_MANAGE_APP_ALL_FILES_ACCESS_PERMISSION) that hasn't been decided on for BAI. Wire
     * that in deliberately if/when this needs revisiting.
     */
