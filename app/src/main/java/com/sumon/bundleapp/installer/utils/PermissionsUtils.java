...
public class PermissionsUtils {
    ...
    /**
     * API 33+ made POST_NOTIFICATIONS a runtime permission. Without this, every
     * notification the app posts (backup progress, install results, etc.) is
     * silently dropped - no crash, just nothing shown to the user.
     */
