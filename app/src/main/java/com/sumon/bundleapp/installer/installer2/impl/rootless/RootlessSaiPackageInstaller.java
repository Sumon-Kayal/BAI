...
import com.sumon.bundleapp.installer.installer2.base.model.SaiPiSessionStatus;
import com.sumon.bundleapp.installer.installer2.impl.BaseSaiPackageInstaller;
...
public class RootlessSaiPackageInstaller extends BaseSaiPackageInstaller implements RootlessSaiPiBroadcastReceiver.EventObserver {
    ...
    private RootlessSaiPackageInstaller(Context c) {
        ...
        ContextCompat.registerReceiver(getContext(), mBroadcastReceiver, new IntentFilter(RootlessSaiPiBroadcastReceiver.ACTION_DELIVER_PI_EVENT), null, mWorkerHandler, ContextCompat.RECEIVER_NOT_EXPORTED);
